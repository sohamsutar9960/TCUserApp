...
interface UserSelectionProps {
  ...
  handleNext: () => void;
  dataChangeForUserSelection: (data1: any, data2: any) => void;
  getStateName: (stateName: string) => void;
  userRequest: any;
}
...
function UserSelection({
  ...
  useEffect(() => {
    setGroupRoleApproversById(userRequest.user1);
    setShowSearchUserData(userRequest.user2);

    if (userRequest.user2 && Object.keys(userRequest.user2).length > 0) {
      setIsDataAdded(true);
    }
  }, []);
  ...
  const handleProceedForMyself = async () => {
    dataChangeForUserSelection(groupRoleApproversById, {});
    handleNext();
  };

  const handleProceedForAnotherUser = async () => {
    if (groupRoleApproversById?.GID == gid2) {
      handleOpenPopup();
    } else {
      dataChangeForUserSelection({}, showSearchUserData);
      handleNext();
    }
  };
  ...
  useEffect(() => {
    if (logInUserData && logInUserData.user) {
      fetchGroupRoleApproversById(logInUserData.user?.user?.gid);
    }
  }, []);
        ...
        <Box>
          ...
          <Box style={{ display: "flex" }}>
            <Box style={{ width: "50%", padding: "20px" }}>
              ...
              >
                Create/Modify User Account for Myself
              </Typography>
              <TableContainer>
                <Table>
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell
                        sx={{
                          borderBottom: "none",
                          padding: "4px",
                          cursor: readOnly || disabled ? "not-allowed" : "auto",
                        }}
                      >
                        <StyledTextFieldModal
                          id="last-name1"
                    ...
                    <TableRow>
                      ...
                      >
                        <Button
                          variant="contained"
                          onClick={handleProceedForMyself}
                          sx={{
                            padding: "3px 6px",
                            fontSize: "0.7rem",
                            minWidth: "60px",
            ...
            <Box style={{ width: "50%", padding: "20px" }}>
              <Typography
                ...
                sx={{ fontSize: "0.9rem", fontWeight: "bold" }}
              >
                Create/Modify User Account for Another User
              </Typography>
              <TableContainer>
                <Table>
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      >
                        ...
                        >
                          ...
                          <Button
                            variant="contained"
                            onClick={handleProceedForAnotherUser}
                            sx={{
                              alignItems: "center",
                              padding: "3px 6px",
                              fontSize: "0.7rem",
              ...
              <TableHead>
                <StyledHeaderTableCell colSpan={6}>
                  <Typography
                    ...
                    sx={{ color: "red", fontSize: "12px" }} // Reduced font size
                  >
